...
if (isset($_POST['login'])) {
    ...
    $query = $link->prepare("SELECT * FROM counselor WHERE uname = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $fetch['password'])) {
            try {
                ...
                $query = "UPDATE `counselor` SET `otp` = '$otp' WHERE `uname` = '$uname '";
            ...
            background-color: #0056b3;
                    ...
                    <body>
                        <div class='container'>
                            ...
                            <p class='otp'>$otp</p>
                            <a href='http://localhost/gcms/counselor/coun_login.php' class='button' style='color: #fff;'>Visit our website</a>
                        </div>
                    </body>
                    </html>";
                    $mail->send();
                                ...
                                <div class="p-5">
                                    ...
                                    <form method="POST" class="user">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="uname" placeholder="Enter Username...">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="coun_fpassword.php">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
